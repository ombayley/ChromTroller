...
from LAMA.LCMSLama.peak.match import update_matches, match_peak
from LAMA.LCMSLama.peak.process import process_peak

from LAMA.LCMSLama.user_interaction.user_objects import Compound
