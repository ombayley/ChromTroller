...
from LAMA.LCMSLama.dad_data.utils import trim_data
from LAMA.LCMSLama.dad_data.process_gradientdata import bsl_als
from LAMA.LCMSLama.dad_data.apis.chemstation import read_chemstation
from LAMA.LCMSLama.dad_data.apis.labsolutions import read_labsolutions
from LAMA.LCMSLama.dad_data.apis.empower import read_empower
from LAMA.LCMSLama.dad_data.apis.allotrope import read_adf
from LAMA.LCMSLama.dad_data.apis.custom import read_custom_data
from LAMA.LCMSLama.dad_data.apis.angi import read_angi
from LAMA.LCMSLama.dad_data.apis.openlabcds import read_openlabcds
...
class DadData():
    ...
    """
    hplc_system_tag: str
    experiment: InitVar["LAMA.LCMSLama.user_interaction.user_objects.DadInput"]
    ...
    def _read_data(self, wl_high_pass, wl_low_pass, experiment):
        ...
        if self.hplc_system_tag == 'chemstation':
            ...
            data, time, wavelength = read_angi(self.path, wl_high_pass,
                                               wl_low_pass)
        elif self.hplc_system_tag == 'openlab':
            data, time, wavelength = read_openlabcds(self.path, wl_high_pass,
                                                     wl_low_pass)
...
class ParafacData():
    ...
    impure_peak: InitVar['LAMA.LCMSlama.peak.models.CorrectedPeak']
