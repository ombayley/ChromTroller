...
def match_component(self, chromatogram, components_list, retention_time, uv_spectra=None, ms_spectra_peak=None):
    ...
    min_elut_time = retention_time - self.proc_settings.max_peak_distance
    max_elut_time = retention_time + self.proc_settings.max_peak_distance
    ...
    for component in components_list:
        ...
        if uv_spectra and cosine_similarity(component.spectrum,
                                            uv_spectra) >= self.proc_settings.min_spectrum_correl:
