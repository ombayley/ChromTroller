...
"""
Author: O. Bayley
Description: A general base class for communication with an Arduino Device, containing the essentials
of serial communication. No task-specific methods are included.
"""
import time
