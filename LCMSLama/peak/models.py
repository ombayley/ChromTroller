...
import LAMA.LCMSLama.dad_data.models
...
class PickedPeak(BasePeak):
    ...
    dataset : 'LAMA.LCMSLama.dad_data.models.CompoundData'  # DADData parent of peak
    idx : int
...
class ProcessedPeak():
    ...
    maximum : int
    offset : int
    dataset : 'LAMA.LCMSLama.dad_data.models.CompoundData'
    idx : int
    saturation : bool
    pure : bool
    integral : float
