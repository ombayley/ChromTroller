...
import logging
import dill
# init of campaign instance
from LAMA.LCMSLama.peak.database import PeakDatabase
from LAMA.LCMSLama.components.databases import QualiComponentDatabase
from LAMA.LCMSLama.components.databases import QuantComponentDatabase

# process functions
from LAMA.LCMSLama.campaign.process_funcs import process_compound_experiments
from LAMA.LCMSLama.campaign.process_funcs import process_experiments
from LAMA.LCMSLama.campaign.process_funcs import process_gradients
...
class HplcDadCampaign:
    ...
    def process_new_hplc_input(self):
        ...
        can only be changed via process_all_hplc_input.
        """
        process_gradients(self.hplc_inputs, self.settings)
